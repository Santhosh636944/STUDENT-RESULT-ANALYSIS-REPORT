...
const ResumeBuilderCreative = () => {
  const [form, setForm] = React.useState({
    name: '',
    experience: [{ role: '', company: '', from: '', to: '' }],
    education: [{ college: '', from: '', to: '', degree: '' }],
    skills: [''], // Start with an empty field for skills
    languages: [''], // Start with an empty field for languages
    certifications: [''], // Start with an empty field for certifications
  ...
  return (
    <div className="resume-builder-container-creative">
...
export default ResumeBuilderCreative;
